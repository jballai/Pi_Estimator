...
def base_six_to_decimal():
    ...
    of 3 die rolls and in order, converting that sequence as a number of base 6 to a decimal.  For instance, if I roll a 3, 5, and then 2, the 
    created sequence is 352.  Then, 352 converted from base 6 to a decimal is 140. 
    ...
    example) by 215 because that is the highest possible number that can be created by a 3-digit base 6 number and the highest number
    ...
    '''
    base_6 = str(rollDice()) + str(rollDice()) + str(rollDice()) + str(rollDice()) 
    if base_6 == '0000':
        return 0
